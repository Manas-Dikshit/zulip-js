...
| `zulip.filters.create()` | POST `/realm/filters` | create a filter in a realm. |
| `zulip.filters.deleteById()` | DELETE `/realm/filters/<filter_id>` | delete a filter in a realm by id. |
